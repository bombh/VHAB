...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : '_include/img/slider-images/bles/image01.jpg', title : '<div class="slide-content">In the old city of Brussels ...</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/bles/image02.jpg', title : '<div class="slide-content">so charming guesthouse ...</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/bles/image03.jpg', title : '<div class="slide-content">"La vieille Halle Aux Blés"</div>', thumb : '', url : ''}
									],
